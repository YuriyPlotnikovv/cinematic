...
const sortingByDefaut = (first, second) => second.id - first.id;

const sortingByDate = (first, second) => dayjs(second.filmInfo.release.date).diff(first.filmInfo.release.date);

const sortingByRate = (first, second) => second.filmInfo.totalRating - first.filmInfo.totalRating;

const sortFilmsByComments = (first, second) => second.comments.length - first.comments.length;
